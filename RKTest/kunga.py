import math        # module mathematique pour Python
 
def Runge_Kutta_step(y, t, delta, f) :  # incrementation
    k1 = f( y , t)
...
y = 0              # condition initiale de l'equation differentielle
